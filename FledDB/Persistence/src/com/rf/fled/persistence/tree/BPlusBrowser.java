 ...
 * @author REx
 */
public class BPlusBrowser implements IBrowser<KeyValuePair<Long, Object>>
{
    /**
            ...
            if (pair != null)
            {
                ...
                catch (IOException ex)
                {
                    throw new FledPersistenceException(
                            "could not deserialize value", ex);
                }
            }
            return true;
        }
            ...
            throws FledPersistenceException
    {
        ...
        else
        {
            ...
            if (page == null)
            {
                ...
                throw new FledPersistenceException(
                        "next page was missing: data integrity compromised");
            }
