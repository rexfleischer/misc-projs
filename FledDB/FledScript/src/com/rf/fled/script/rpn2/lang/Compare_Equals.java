 ...
 * @author REx
 */
public class Compare_Equals implements ICompilingOperation
{
            ...
            throws FledSyntaxException
    {
        ...
        {
            writer.writeOperation(ByteCodeOperation.EQ_N);
        ...
        {
            writer.writeOperation(ByteCodeOperation.EQ_U);
            environment.push(new Value(Value.ValueType.BOOLEAN, null));
        }
        else
        {
            switch(left.type)
            {
                case BOOLEAN:
                    ...
                    {
                        writer.writeOperation(ByteCodeOperation.EQ_B);
                        environment.push(new Value(Value.ValueType.BOOLEAN, null));
                    }
                ...
                case STRING:
                    ...
                    {
                        writer.writeOperation(ByteCodeOperation.EQ_S);
                        environment.push(new Value(Value.ValueType.BOOLEAN, null));
                    }
                ...
                case OBJECT:
                    ...
                    {
                        writer.writeOperation(ByteCodeOperation.EQ_O);
                        environment.push(new Value(Value.ValueType.BOOLEAN, null));
                    }
                    if (right.type == Value.ValueType.STRING)
                    {
