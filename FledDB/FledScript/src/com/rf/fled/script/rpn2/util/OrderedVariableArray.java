 ...
 * @author REx
 */
public class OrderedVariableArray<_Ty>
{
    ...
    public OrderedVariableArray(int size) 
            throws FledScriptInitException
    {
        if (size < 5)
        {
            throw new FledScriptInitException(
                    "cannot make a variable array less than 5 in size");
        }
