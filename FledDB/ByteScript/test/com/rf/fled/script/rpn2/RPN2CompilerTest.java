...
import com.rf.bytescript.compiler.CompilerFactory;
...
public class RPN2CompilerTest
{
    ...
    public ICompiler getCompiler(String type) throws Exception
    {
        Properties props = new Properties();
        props.setProperty("executor", type);
        return (ICompiler) CompilerFactory.GENERAL.getInstance(props);
    }
