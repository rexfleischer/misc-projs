...
public class OrderedNamedValueArray<_Ty>
{
     ...
     */
    public boolean setValue(String name, _Ty value) 
    {
        if (compacityUsed == 0)
        {
    ...
    public void removeValue(String name) throws UndefinedValueException
    {
        int index = binarySearchFromName(name);
        if (index < 0)
        {
            throw new UndefinedValueException(name + " is not defined");
        }
        else
        {
    ...
    public _Ty getValue(String name) throws UndefinedValueException
    {
        int index = binarySearchFromName(name);
        if (index < 0)
        {
    ...
    public _Ty getValueSafe(String name)
    {
        int index = binarySearchFromName(name);
        if (index < 0)
        {
    ...
    public void addNamedValueSet(OrderedNamedValueArray<_Ty> adding)
    {
        ...
        {
            this.setValue(pair.name, pair.value);
        }
    }
