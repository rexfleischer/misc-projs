 ...
 * @author REx
 */
public class RestRouterTest_single
{
    
    public RestRouterTest_single()
    {
    }
    ...
    public RestRouter getRouter() 
            throws Exception
    {
        return new RestRouter(new String[]{"com.rf.fledrest.router._single"});
    }
            ...
            throws Exception
    {
        ...
        context.method = MethodReverse.GET;
        return context;
    }
    ...
    public void test_happytest1() throws Exception
    {
        ...
        RestContext context = getContext("hello", "/world/blah", null);
        
        RestResponse Response = router.route(context);
        Assert.assertEquals(200, Response.status);
        Assert.assertEquals("hello world! blah", Response.data);
    }
    ...
    public void test_happytest2() throws Exception
    {
        ...
        RestResponse Response = router.route(context);
        Assert.assertEquals(200, Response.status);
        Assert.assertEquals("hello world! something_here", Response.data);
    }
    ...
    public void test_happytest3() throws Exception
    {
        ...
        RestResponse Response = router.route(context);
        Assert.assertEquals(200, Response.status);
        Assert.assertEquals("hello world! ka ka", Response.data);
    }
