 ...
 * @author REx
 */
public class RestRouterTest_multiple
{
    
    public RestRouterTest_multiple()
    {
    }
    ...
    public RestRouter getRouter() 
            throws Exception
    {
        return new RestRouter(new String[]{"com.rf.fledrest.router._multiple"});
    }
    ...
    public void test_happytest2() throws Exception
    {
        ...
        RestRouter router = getRouter();
        RestContext context = getContext("hello", "/world", null);
        
        RestResponse Response = router.route(context);
        Assert.assertEquals(200, Response.status);
        Assert.assertEquals("hello world2!", Response.data);
    }
    ...
    @Test
    public void test_happytest4() throws Exception
    {
