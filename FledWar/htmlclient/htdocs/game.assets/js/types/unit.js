...
function Unit(base_unit, actions) {
  this.view_type = "unit";
...
Unit.prototype.clicked = function(x, y) {
  return this.graphic.clicked(x, y);
};


Unit.prototype.lclick = function(x, y) {
  menus.enter(system_main_point_json_br, this, true);
};


Unit.prototype.render = function(min_pixels) {
  this.graphic.radius = min_pixels;
...
Unit.prototype.render_actions = function() {
//  var client_x = 
...
Unit.prototype.server_update = function(update) {     
...
Unit.prototype.update = function(gamehours) {
...
Unit.prototype.add_action = function(action) {
  this.actions.push(action);
};


Unit.prototype.remove_action = function(action) {
...
Unit.prototype.set_client_xy = function(x, y) {
...
Unit.prototype.set_server_xy = function(x, y) {
...
Unit.prototype.set_server_ad = function(alpha, distance) {
...
Unit.prototype._impulse_update = function(action, time_delta) {
